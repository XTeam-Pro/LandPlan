...
export default function BankruptcyAuctionsPage() {
  ...
  return (
    <div className="placeholder-page">
      ...
      <div className="placeholder-content">
        ...
        <h2>Торги по банкротству</h2>
        <p className="placeholder-status">Раздел в разработке</p>
        <p className="placeholder-desc">
          Здесь будут представлены земельные участки, выставленные на торги в рамках процедуры банкротства.
